...
A automacao E2E da Calculadora do Cidadao (BCB) esta **operacional e estavel**. A suite cobre 16 cenarios de teste (positivos, negativos e de borda), com execucao local ~60s e pipeline de CI configurado.
